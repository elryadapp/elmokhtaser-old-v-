              ...
              return SingleChildScrollView(
                ...
                child: Container(
                  decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                            color: AppUi.colors.borderColor, blurRadius: 5)
                      ]),
                  width: 90.w,
                  ...
                  child: Column(
                    ...
                    children: [
                      AppUtil.appCachedImage(
                        imgUrl: AppUi.assets.networkImageBaseLink+cubit.singleNewsModel!.data!.image!
                      ),
                      SizedBox(
                        height: 2.h,
                      ),
                      Row(
                        ...
                        children: [
                          ...
                          AppText(DateFormat.yMd().format(DateTime.parse(
                              cubit.singleNewsModel!.data!.createdAt!))),
                        ],
                      ),
                      Padding(
