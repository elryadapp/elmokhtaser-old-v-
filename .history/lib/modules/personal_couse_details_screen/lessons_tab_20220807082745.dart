                            ...
                            children: List.generate(
                                ...
                                (childIndex) => Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Row(
                                          children: [
                                            childIndex == cubit.currentIndex&&courseContent[index].childs![childIndex].type=='video'
                                                ? Icon(IconBroken.Play,color: AppUi.colors.mainColor,)
                                                : Icon(IconBroken.Document, color:childIndex == cubit.currentIndex? AppUi.colors.mainColor:AppUi
