      ...
      builder: (context, state) {
        ...
        return Padding(
          ...
          child: SingleChildScrollView(
            ...
            child: cubit.singleCourseContentItem!.isNotEmpty
                ? Column(
                    children: [
                      SizedBox(
                        height: 3.h,
                            ...
                            return AppListTile(
                                ...
                                content: Column(
                                  children: List.generate(
                                      ...
                                      (childIndex) {
                                        var icon;
                        switch( courseContent[index].childs![childIndex].type){
                            case 'video':
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                cubit.changeColorOnTab(
                                                    childIndex, index);
                                                    if(courseContent[index].childs![childIndex].type=='note'){
                                                      cubit.addCourseToProgress(context, courseContent[index].childs![childIndex].id).then((value) => print( courseContent[index].childs![childIndex].progressable));
                ...
                : Column(
                    children: [
                      ...
                      AppText(
                          'there_are_no_content_added_to_this_course_yet'.tr()),
                      SizedBox(
                        height: 10.h,
                      )
                    ],
